<?php
$hero_img         = get_field('coo_hero_img');
$title_h1         = get_field('coo_title_h1');
$hero_description = get_field('coo_hero_description');
$button_text      = get_field('coo_button_text');
$button_link      = get_field('coo_button_link');
?>
